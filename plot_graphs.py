...
data1 = np.loadtxt('sim_data\\after_bug_fix\\fermi1.txt')
data2 = np.loadtxt('sim_data\\after_bug_fix\\fermi2.txt')
...
plt.plot(data1[:, 0], data1[:, 1], linestyle='-', label='77K, E_f = -0.05')
plt.plot(data2[:, 0], data2[:, 1], linestyle='--', label='77K, E_f = -0.1')

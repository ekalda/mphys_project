...
my_system.add_system_object(SquareBarrier('barrier', 20.*A, 0.5*eV, 0.067*me))
my_system.add_system_object(SquareBarrier('well', 50.*A, 0.0, 0.067*me))
my_system.add_system_object(SquareBarrier('barrier', 20.*A, 0.5*eV, 0.067*me))
...
print(sum(my_system.sys[2].width_array))
